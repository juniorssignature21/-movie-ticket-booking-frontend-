  ...
  const offers = [
    {
      ...
      isBanner: true,
      title: '30%',
      subtitle: 'Movie vouchers free',
      image: new URL('../assets/discounts/E7Uon1_4_.png', import.meta.url).href,
    },
    {
      id: 1,
      title: 'Movie Name',
      image: new URL('../assets/discounts/Rectangle 20.png', import.meta.url).href,
      originalPrice: 5000,
      discount: 50,
      finalPrice: 2500,
    },
    {
      id: 2,
      title: 'Movie Name',
      image: new URL('../assets/discounts/Rectangle 21.png', import.meta.url).href,
      originalPrice: 5000,
      discount: 50,
      finalPrice: 2500,
    },
    {
      id: 3,
      title: 'Movie Name',
      image: new URL('../assets/discounts/Rectangle 21-1.png', import.meta.url).href,
      originalPrice: 5000,
      discount: 50,
      finalPrice: 2500,
    },
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-tr from-black/80 via-black/40 to-transparent flex items-center justify-center p-6 text-center">
                    <div className="bg-black/40 backdrop-blur-md border border-white/10 p-6 rounded-2xl max-w-xs flex flex-col items-center">
                      ...
                      {offer.id === 'promo-banner' && (
                        <span className="text-xs font-bold text-white tracking-widest mt-0.5">
                          OFF
                        </span>
                      )}
